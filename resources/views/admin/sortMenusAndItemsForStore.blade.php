...
<div class="page-header">
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4>
                <span class="font-weight-bold mr-2">Sorting Menu and Items for: <a href="{{ route('admin.get.editRestaurant', $restaurant->id) }}"><b>{{ $restaurant->name }}</b></a></span>
            </h4>
    ...
    $(function() {
        $('.sortable').sortable({
            ...
            onUpdate: function (evt) {
                ...
                $.ajax({
                  url: '{{ route('admin.updateItemPositionForStore') }}',
                  type: 'POST',
                  dataType: 'JSON',
        ...
        $('#sortable-menu').sortable({
            ...
            onUpdate: function (evt) {
                ...
                $.ajax({
                  url: '{{ route('admin.updateMenuCategoriesPositionForStore') }}',
                  type: 'POST',
                  dataType: 'JSON',
                  data: {newOrder: newSortOrder, _token: $('#token').val()},
              })
